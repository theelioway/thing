...
describe(`class | ThingBuilder | Thing schemaorg 9.0`, () => {
  ...
  it.only(`builds things single HealthAndBeautyBusiness`, () => {
    let opts = { depth: 0, comment: false }
    let thing = this.thingBuilder.Thing(["HealthAndBeautyBusiness"], opts)
    fs.writeFileSync("./thing.json", JSON.stringify(thing))
    fs.writeFileSync(
      "./expectHealthAndBeautyBusiness.json",
      JSON.stringify(expectHealthAndBeautyBusiness)
    )

...
describe("module | Thing", () => {
  it.only("returns `thing` from blank", async () => {
  ...
  it.only("returns fuller `thing` from skinny `thing`", async () => {
  ...
  it.only("returns the `mainEntityOfPage` type of `thing`", async () => {
  ...
  it.only("returns with all the types of a `thing`", async () => {
    await Thing({
